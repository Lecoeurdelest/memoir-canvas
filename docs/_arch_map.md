...
| `src/mcp/modelContext.ts` | async registration, AbortSignal withdrawal, legacy API compatibility | `TASK-006`, `TASK-046` |
...
| `src/view/GuidedStory.tsx` | guided family interview, stage-aware prompts and reviewed printable keepsake | `TASK-047` |
...
| `tests/modelContext.spec.ts` | modern/legacy withdrawal, live handlers, registration failures and cleanup | `TASK-006`, `TASK-046` |
