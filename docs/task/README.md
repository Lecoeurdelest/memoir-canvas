...
44 tasks, six days, three branches. Numbering leaves room — new tasks go on the end, never
...
| [`TASK-032`](TASK-032-photos-on-the-road.md) | Photographs, with nothing to configure | C | 5 | `TASK-030` | ☑ |
